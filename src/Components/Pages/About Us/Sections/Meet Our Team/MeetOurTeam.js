    ...
    return (
        <section id='meetourteam' style={{ backgroundColor: 'darkred' }} className='MeetOurTeamContainer'>
            ...
            <div style={{ color: 'white' }}>
                ...
                <br />
                <button className='SeeTheWholeTeamButton' style={{ margin: '0 auto', display: 'block', fontSize: '20px' }}><Link  style={{color: 'white', textDecoration: 'none'}} to="/viewentireteam" >View Entire Team</Link></button>
                <br />
                <br />
            </div>
        </section >
