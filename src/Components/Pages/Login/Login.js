    ...
    return (
        <>
            <form onSubmit={handleSubmit}>
                ...
                <button className="SignUpButton" onClick={() => { Checkpassword(); usernameValidation(); }}>Login</button>
                <span style={{ color: "white" }} className="span-handle" > Don't have an account? <Link style={{ color: "red" }} className="nav-link active" aria-current="page" to="/register">Register</Link> </span>
            </form>
            {show ? (
                <p className="popup">
